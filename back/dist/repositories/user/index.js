...
exports.userRepo = config_1.AppDataSource.getRepository(User_1.User).extend({
    getAll: function () {
    ...
    createUser: function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var credentialId, newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, credential_1.credentialRepo.createCredential({
