...
var getUsersService = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, user_1.userRepo.getAll()];
            case 1:
                users = _a.sent();
                return [2, users];
            case 2:
...
var getUserByIdService = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, user_1.userRepo.getById(id)];
            case 1:
                user = _a.sent();
                return [2, user];
            case 2:
...
var registerUserService = function (userData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, user_1.userRepo.createUser(userData)];
            case 1:
                user = _a.sent();
                return [2, user];
            case 2:
...
var loginUserService = function (credentials) { return __awaiter(void 0, void 0, void 0, function () {
    var checkedCredentials, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                checkedCredentials = _a.sent();
                return [2, checkedCredentials];
            case 2:
                error_4 = _a.sent();
